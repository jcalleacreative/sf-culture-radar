...
ANALYSIS_TARGET_HIGH_SCORE = int(os.getenv("ANALYSIS_TARGET_HIGH_SCORE", "30"))
ANALYSIS_HIGH_SCORE_THRESHOLD = float(os.getenv("ANALYSIS_HIGH_SCORE_THRESHOLD", "7.0"))
ANALYSIS_BATCH_SIZE = int(os.getenv("ANALYSIS_BATCH_SIZE", "30"))
ANALYSIS_MAX_ITERATIONS = int(os.getenv("ANALYSIS_MAX_ITERATIONS", "10"))
